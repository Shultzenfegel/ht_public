...
(($) => {
    ...
    function initHeaderHandlers() {
        ...
        $('body').click((e) => {
            let isOpened = $(e.target).closest('.b-nav__select').hasClass('b-nav__select_opened');
    ...
    function initDialogHandlers() {
        ...
        function initSwitchDialogLink(dialog) {
            $('.b-dialog__link_' + dialog).click((e) => {
                closeDialogs();
        ...
        initSwitchDialogLink('restore');

        // Отображает текст ошибки в форме
        ...
        $('.b-nav__button_signout, .b-nav__icon_signout').click((e) => {
            $.ajax({
                url: '/user/logout',
                method: 'get'
            })
    ...
    function initMainFormHandlers() {
        ...
        $('body').click((e) => {
            let isOpened = $(e.target).closest('.b-main-select').hasClass('b-main-select_opened');
        ...
        $('.b-main-button').click((e) => {
            let hobby = $('#hobby').val();
            let country = $('#country').val();
            if (!hobby || !country) {
                return false;
            }
            window.location = `/${hobby}/search/${country}`;
        });
    }
